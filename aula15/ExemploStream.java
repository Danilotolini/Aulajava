...
public class ExemploStream {
    public static void main(String[] args) {
        List<Funcionario> list = new ArrayList<>();/* Cria uma lista vazia de funcionarios. */
        /* Adiciona alguns funcionarios a lista. */
        list.add(new Funcionario(2005, "Eduardo Alves", "Desenvolvedor", 3580.0));
        ...
        list.add(new Funcionario(1389, "Eduardo Alves",   "Desenvolvedor", 3200.0));
